...
| NVDriverForge | nvdriverforge-v0.1.4 | বিদ্যমান 0.x স্কিম; সংস্করণযুক্ত আপডেটগুলি আগের প্যাকেজগুলিকে সংরক্ষণ করে |
| NVMFG Unlock40 | nvmfg-unlock40-v0.2.3 | অ্যাপ্লিকেশন সংস্করণ 0.2.3; সর্বজনীন 0.1.1 থেকে ক্রমবর্ধমান পরিবর্তন |
| NVRasterPulse | nvrasterpulse-v0.2 | বিদ্যমান দুই-অংশের সংস্করণ |
...
সেপ্টেম্বর 18 আপডেট তিনটি নতুন ট্যাগ প্রস্তুত করে; বিদ্যমান Profile Inspector রিলিজ অপরিবর্তিত থাকে। অ্যাসেটের নাম, ট্যাগ এবং `SHA256SUMS.txt` অবশ্যই অ্যাপ্লিকেশান আপডেট চেকের জন্য সঠিক থাকতে হবে। প্রি-রিলিজ ফ্ল্যাগ ছাড়াই সাধারণ রিলিজগুলিকে স্থিতিশীল-রিলিজ চেকের কাছে প্রকাশ করতে প্রকাশ করুন; NVMFG পরীক্ষামূলক রয়ে গেছে।

<a id="integrity-and-storage"></a>
## সততা এবং স্টোরেজ

প্রকাশিত বাইনারি বাইটগুলি কখনই নীরবে প্রতিস্থাপন করবেন না। নতুন হ্যাশ সহ একটি নতুন স্পষ্ট সংস্করণ বা ইনস্টলার সংশোধন ব্যবহার করুন। আইনি সাইডকারগুলি এমবেডেড নোটিশের পরিপূরক। NVDriverForge 0.1.4 পোর্টেবল হল 142,017,891 বাইট, GitHub এর সাধারণ 100 MiB গিট-ফাইল সীমার উপরে। রিলিজ সংযুক্তিগুলি এই হাবে বাইনারি বা গিট এলএফএস স্থাপন করা এড়ায়। [GitHub বড়-ফাইল নির্দেশিকা](https://docs.github.com/en/repositories/working-with-files/managing-large-files/about-large-files-on-github)।
