...
[0.1 및 상태 다운로드](../docs/downloads.md#nvrasterpulse) · [설치](#installation) · [한도 작동 방식](#usage) · [라이센스](../../../../NVRasterPulse/LICENSE)
...
전체 RTSS 프로필을 교체하거나 오버레이 설정을 방해하지 않고도 정확한 게임별 제한을 더 쉽게 편집할 수 있도록 하기 위해 존재합니다. 현재 **0.1** 후보는 RTSS 설치 확인이 필요한 2026년 9월 9일 빌드입니다.
...
3. `NVRasterPulse-0.1-win-x64-Setup.exe` 또는 `NVRasterPulse-0.1-win-x64-portable.zip`와 알림/체크섬을 다운로드합니다.
