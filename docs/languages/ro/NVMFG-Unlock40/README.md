...
[Descărcați 0.1.1 și starea](../docs/downloads.md#nvmfg-unlock40) · [Instalare](#installation) · [în amonte](#upstream-and-modifications) · [Licențe](LICENSES/README.md)
...
Candidatul pregătit este **0.1.1**, inclusiv corecția vizuală a listei SDK înregistrată intern ca UI2. Versiunea publică rămâne 0.1.1; hashe-urile sale exacte disting acest candidat de versiunile locale mai vechi.
...
2. Descărcați `NVMFGUnlock40-0.1.1-Setup-x64.exe` sau `NVMFGUnlock40-0.1.1-Portable-x64.zip` când versiunea sa este disponibilă.
