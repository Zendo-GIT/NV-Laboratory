...
2. Перегляньте документацію, повідомлення, зображення, метадані JSON і інструмент перевірки документації.
...
| NVDriverForge | nvdriverforge-v0.1.3 | Існуюча схема 0.x; версійні оновлення зберігають попередні пакунки |
| NVMFG Unlock40 | nvmfg-unlock40-v0.1.1 | Кандидат UI2 визначається точними хешами без винаходу нової версії програми |
| NVRasterPulse | nvrasterpulse-v0.1 | Існуюча версія з двох частин |
...
Ніколи мовчки не замінюйте опубліковані двійкові байти. Використовуйте нову явну версію або редакцію інсталятора з новими хешами. Юридичні коляски доповнюють вбудовані повідомлення. NVDriverForge 0.1.3 portable становить 141 760 351 байт, що перевищує звичайний ліміт Git-файлу GitHub у 100 МіБ. Уникайте розміщення двійкових файлів або Git LFS у цьому хабі. [Керівництво по великому файлу GitHub](https://docs.github.com/en/repositories/working-with-files/managing-large-files/about-large-files-on-github).
