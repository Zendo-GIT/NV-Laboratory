...
此审核描述了 **2026-09-09** 准备的候选人。应用程序来源保持私密；公共清单包含文件名和哈希值，而不是源代码。请参阅 [完整组件通知](../THIRD_PARTY_NOTICES.md)。
...
候选引擎 SHA-256：`0E7FC0277C88B22095B622F6A3CB292EC0C14F7A0253D392502257B75E548890`。
