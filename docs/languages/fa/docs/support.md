...
| NVDriverForge 0.1.4 | Windows 10 ساخت 19041+ / 11 x64; NET/WPF گنجانده شده است | بسته درایور سازگار NVIDIA | نصب بالا، تنظیمات پیشرفته، اختیاری NVENC |
| NVMFG Unlock40 0.2.3 | Windows 10/11 x64; شامل NET/WPF، راهنماهای Framework 4.8 | RTX 40، بازی واجد شرایط DLSS FG و ارائه دهنده پین شده | وصله داخلی درون بازی، ژورنال پروفایل جهانی، به‌روزرسانی‌های بازی SDK |
| NVRasterPulse 0.2 | Windows 10/11 x64، .NET Framework 4.8 | RTSS نصب شده است. دویدن برای کلاه | RTSS در هر نمایه اجرایی تغییر می کند |
...
NVDriverForge یک گزارش محلی قابل پیش نمایش JSON را ارائه می دهد. NVMFG یک تشخیص در About ارائه می دهد. این گزارش‌های فیلتر شده را به یک آرشیو گزارش کامل ترجیح دهید و قبل از اشتراک‌گذاری آن‌ها را بررسی کنید. انسداد بازسازی گزارش شده در NVMFG 0.1.1 هنوز هیچ دلیل ثابتی ندارد. ژورنال خود را حفظ کرده و هر کد خطای موجود را ثبت کنید. NVRasterPulse 0.2 بدون اندازه‌گیری FPS، عیب‌یابی پیکربندی را در منوی اقدامات خود ارائه می‌دهد.
