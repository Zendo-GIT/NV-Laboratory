...
2. اسناد، اعلامیه‌ها، تصاویر، فراداده JSON و اعتبارسنجی اسناد را بررسی کنید.
...
| NVDriverForge | nvdriverforge-v0.1.3 | طرح 0.x موجود؛ به روز رسانی های نسخه شده بسته های قبلی را حفظ می کنند |
| NVMFG Unlock40 | nvmfg-unlock40-v0.1.1 | نامزد UI2 با هش های دقیق بدون اختراع نسخه برنامه جدید شناسایی می شود |
| NVRasterPulse | nvrasterpulse-v0.1 | نسخه دو قسمتی موجود |
