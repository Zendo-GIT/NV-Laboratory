...
この監査では、**2026-09-09** に準備された候補者について説明します。アプリケーションのソースは非公開のままです。パブリック インベントリには、ソース コードではなく、ファイル名とハッシュが含まれます。 [フルコンポーネントの通知](../THIRD_PARTY_NOTICES.md)を参照してください。
...
候補エンジン SHA-256: `0E7FC0277C88B22095B622F6A3CB292EC0C14F7A0253D392502257B75E548890`。
