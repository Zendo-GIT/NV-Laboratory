...
2. Suriin ang dokumentasyon, mga abiso, mga larawan, JSON metadata at ang validator ng dokumentasyon.
...
| NVDriverForge | nvdriverforge-v0.1.4 | Umiiral na 0.x scheme; pinapanatili ng mga bersyong update ang mga naunang pakete |
| NVMFG Unlock40 | nvmfg-unlock40-v0.2.3 | Bersyon ng application 0.2.3; pinagsama-samang pagbabago mula noong pampublikong 0.1.1 |
| NVRasterPulse | nvrasterpulse-v0.2 | Umiiral na dalawang bahagi na bersyon |
...
Ang pag-update ng Setyembre 18 ay naghahanda ng tatlong bagong mga tag; ang kasalukuyang Profile Inspector Release ay nananatiling hindi nagbabago. Dapat manatiling eksakto ang mga pangalan ng asset, tag at `SHA256SUMS.txt` para sa mga pagsusuri sa pag-update ng application. Mag-publish ng mga normal na Release nang walang flag ng prerelease upang ilantad ang mga ito sa mga stable-release na pagsusuri; Ang NVMFG ay nananatiling eksperimento.

<a id="integrity-and-storage"></a>
## Integridad at imbakan

Huwag kailanman tahimik na palitan ang na-publish na mga binary byte. Gumamit ng bagong tahasang bersyon o rebisyon ng installer na may mga bagong hash. Ang mga legal na sidecar ay pandagdag sa mga naka-embed na abiso. Ang NVDriverForge 0.1.4 portable ay 142,017,891 bytes, higit sa ordinaryong 100 MiB Git-file na limitasyon ng GitHub. Iwasan ng mga release na attachment ang paglalagay ng mga binary o Git LFS sa hub na ito. [GitHub malaking-file na gabay](https://docs.github.com/en/repositories/working-with-files/managing-large-files/about-large-files-on-github).
