...
| NVDriverForge | nvdriverforge-v0.1.4 | Существующая схема 0.x; Версионные обновления сохраняют более ранние пакеты |
| NVMFG Unlock40 | nvmfg-unlock40-v0.2.3 | Версия приложения 0.2.3; накопительные изменения с момента публикации 0.1.1 |
| NVRasterPulse | nvrasterpulse-v0.2 | Существующая версия, состоящая из двух частей |
...
Обновление от 18 сентября готовит три новых тега; существующая версия Profile Inspector остается без изменений. Имена активов, теги и `SHA256SUMS.txt` должны оставаться точными для проверки обновлений приложения. Публикуйте обычные выпуски без флага предварительной версии, чтобы подвергать их проверке стабильных выпусков; НВМФГ остается экспериментальным.

<a id="integrity-and-storage"></a>
## Целостность и хранение

Никогда не заменяйте опубликованные двоичные байты молча. Используйте новую явную версию или версию установщика с новыми хэшами. Юридические сайдкары дополняют встроенные уведомления. Портативный NVDriverForge 0.1.4 имеет размер 142 017 891 байт, что превышает обычный лимит Git-файла GitHub в 100 МБ. При выпуске вложений избегайте размещения двоичных файлов или Git LFS в этом хабе. [Руководство по работе с большими файлами GitHub](https://docs.github.com/en/repositories/working-with-files/managing-large-files/about-large-files-on-github).
