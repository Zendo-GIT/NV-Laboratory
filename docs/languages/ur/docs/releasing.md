...
2. دستاویزات، نوٹسز، تصاویر، JSON میٹا ڈیٹا اور دستاویزات کی تصدیق کرنے والے کا جائزہ لیں۔
...
| NVDriverForge | nvdriverforge-v0.1.4 | موجودہ 0.x اسکیم؛ ورژن شدہ اپ ڈیٹس پہلے کے پیکجوں کو محفوظ رکھتی ہیں۔ |
| NVMFG Unlock40 | nvmfg-unlock40-v0.2.3 | ایپلیکیشن ورژن 0.2.3؛ عوامی 0.1.1 کے بعد سے مجموعی تبدیلیاں |
| NVRasterPulse | nvrasterpulse-v0.2 | موجودہ دو حصوں والا ورژن |
...
18 ستمبر کی تازہ کاری تین نئے ٹیگ تیار کرتی ہے۔ موجودہ Profile Inspector ریلیز میں کوئی تبدیلی نہیں ہے۔ Asset names, tags and `SHA256SUMS.txt` must remain exact for the application update checks. عام ریلیز کو پری ریلیز فلیگ کے بغیر شائع کریں تاکہ انہیں مستحکم ریلیز چیکس کے سامنے لایا جا سکے۔ NVMFG remains experimental.

<a id="integrity-and-storage"></a>
## سالمیت اور اسٹوریج

کبھی بھی خاموشی سے شائع شدہ بائنری بائٹس کو تبدیل نہ کریں۔ نئی ہیشز کے ساتھ ایک نیا واضح ورژن یا انسٹالر ریویژن استعمال کریں۔ قانونی سائڈ کارس ایمبیڈڈ نوٹسز کی تکمیل کرتے ہیں۔ NVDriverForge 0.1.4 پورٹیبل 142,017,891 بائٹس ہے، GitHub کی عام 100 MiB گٹ فائل کی حد سے زیادہ۔ ریلیز منسلکات اس حب میں بائنریز یا Git LFS ڈالنے سے گریز کریں۔ [GitHub بڑی فائل گائیڈنس](https://docs.github.com/en/repositories/working-with-files/managing-large-files/about-large-files-on-github)۔
