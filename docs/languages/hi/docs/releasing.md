...
2. दस्तावेज़, नोटिस, चित्र, JSON मेटाडेटा और दस्तावेज़ सत्यापनकर्ता की समीक्षा करें।
...
| NVDriverForge | nvdriverforge-v0.1.3 | मौजूदा 0.x योजना; संस्करणित अद्यतन पुराने पैकेजों को सुरक्षित रखते हैं |
| NVMFG Unlock40 | nvmfg-unlock40-v0.1.1 | UI2 उम्मीदवार की पहचान नए एप्लिकेशन संस्करण का आविष्कार किए बिना सटीक हैश द्वारा की गई |
| NVRasterPulse | nvrasterPulse-v0.1 | मौजूदा दो भाग संस्करण |
...
कभी भी प्रकाशित बाइनरी बाइट्स को चुपचाप न बदलें। नए स्पष्ट संस्करण या नए हैश के साथ इंस्टॉलर संशोधन का उपयोग करें। कानूनी साइडकार एम्बेडेड नोटिस के पूरक हैं। NVDriverForge 0.1.3 पोर्टेबल 141,760,351 बाइट्स है, जो GitHub की सामान्य 100 MiB Git-फ़ाइल सीमा से ऊपर है। रिलीज़ अटैचमेंट इस हब में बायनेरिज़ या Git LFS डालने से बचें। [GitHub बड़ी फ़ाइल मार्गदर्शन](https://docs.github.com/en/repositories/working-with-files/managing-large-files/about-large-files-on-github).
